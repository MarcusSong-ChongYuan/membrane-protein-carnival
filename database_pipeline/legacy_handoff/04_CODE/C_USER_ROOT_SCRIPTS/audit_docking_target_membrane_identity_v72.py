...
OUT=ROOT/'MemPro_V7_2_membrane_identity_audit_20260813'; OUT.mkdir(exist_ok=True)
...
for s in seed:
    ...
    if p.get('cross_source_conflict_v5'): flags.append('EXISTING_CROSS_SOURCE_CONFLICT')
